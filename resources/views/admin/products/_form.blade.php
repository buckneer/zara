...
<form method="POST"
      ...
      class="zara-form mx-auto py-5" style="max-width:820px;">
    @csrf
    ...
    <div class="card mb-4 border-0 shadow-none" style="background:transparent;">
        <div class="card-body p-0">
            ...
            <div class="mb-4">
                <h2 class="mb-1 display-6 fw-bold" style="letter-spacing: .05em;">{{ $isEdit ? 'Edit Product' : 'New Product' }}</h2>
            ...
            <div class="card mt-4 p-4" style="background:#fff; border:1px solid #e9e9e9;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            @foreach($product->images as $img)
                                ...
                                @endphp
                                <div class="image-thumb position-relative text-center {{ $img->is_primary ? 'primary' : '' }}">
                                    <img src="{{ $imgUrl }}"
                                         alt="{{ $img->alt }}" style="width:140px; height:100px; object-fit:cover;">
                                    <div class="mt-2 small">
                                        <label class="d-block mb-1">
                                            <input type="radio" name="existing_primary" value="{{ $img->id }}"
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text small text-muted mt-1">Max 5MB per image. First uploaded will be primary by default for new uploads.</div>
