                                        ...
                                        <tr class="zara-row">
                                            ...
                                            <td class="zara-td zara-td-actions">
                                                <form action="{{ route('cart.remove') }}" method="POST" onsubmit="return confirm('Remove item from cart?');">
                                                    @csrf
                                                    <input type="hidden" name="key" value="{{ $item['key'] }}">
                                                    <button type="submit" class="btn btn-sm btn-outline-dark zara-action">Remove</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="card border-0 p-0">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mb-2">
                            <a href="{{ route('checkout.create') }}" class="btn btn-dark text-uppercase fw-bold">Proceed to checkout</a>
